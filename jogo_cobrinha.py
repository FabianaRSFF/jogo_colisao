...
barulho_colisao = pygame.mixer.Sound('smw_dragon_coin.wav')
musica_gameover = pygame.mixer.Sound('smw_game_over.wav')
...
pygame.display.set_caption('FabiGame_Soundtrack: BoxCat_Games 08 CPU Talk')
...
def reiniciar_jogo():
    global pontos, comprimento_inicial,  \
        x_cobra, y_cobra, lista_cobra,   \
        lista_cabeca, x_maca, y_maca, morreu
    pontos = 0
    comprimento_inicial = 15
    x_cobra = int(largura/2)
    y_cobra = int(altura/2)
